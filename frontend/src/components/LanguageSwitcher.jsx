  ...
  return (
    <div className={`relative ${className}`} dir="ltr">
      ...
      <select
        ...
        className="appearance-none pl-8 pr-7 py-1.5 rounded-full text-xs font-semibold bg-surface border border-outline-variant text-on-surface hover:border-primary-container focus:outline-none focus:ring-2 focus:ring-primary-container/20 transition-all cursor-pointer"
      >
        {LANGS.map((lang) => (
