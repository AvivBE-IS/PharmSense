...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ background: '#0c0c18' }}>

      {/* Background glow */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background: 'radial-gradient(ellipse at 50% 70%, rgba(109,40,217,0.2) 0%, rgba(37,99,235,0.12) 40%, transparent 65%)',
        }}
      />
      <div
        className="pointer-events-none absolute inset-0"
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: '#475569' }}>Sign in to your account</p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#64748b' }}>Email</label>
              <input
                type="email"
                value={email}
            ...
            {/* Password */}
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#64748b' }}>Password</label>
              <input
                type="password"
                value={password}
