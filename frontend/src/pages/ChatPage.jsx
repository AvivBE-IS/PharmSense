    ...
    <div className="flex flex-col h-[calc(100vh-56px)] bg-slate-100">
      ...
      <div className="flex-shrink-0 bg-white border-t border-slate-200 px-4 md:px-8 py-4">
        ...
        <p className="max-w-3xl mx-auto text-[11px] text-slate-400 mt-2 pl-1">
          Press <kbd className="px-1 py-0.5 rounded bg-slate-100 border border-slate-300 text-[10px]">Enter</kbd> to send · <kbd className="px-1 py-0.5 rounded bg-slate-100 border border-slate-300 text-[10px]">Shift+Enter</kbd> for new line
        </p>
      </div>
