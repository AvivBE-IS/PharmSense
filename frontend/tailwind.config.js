  ...
  theme: {
    extend: {
      colors: {
        ...
        // Design tokens — auto-switch light/dark via CSS variables
      ...
      fontFamily: {
        // Heebo leads every stack — covers Hebrew + Latin beautifully
        "body-md": ["Heebo", "Inter", "sans-serif"],
        "body-sm": ["Heebo", "Inter", "sans-serif"],
        "label-bold": ["Heebo", "Inter", "sans-serif"],
        h1: ["Heebo", "Manrope", "sans-serif"],
        "body-lg": ["Heebo", "Inter", "sans-serif"],
        h3: ["Heebo", "Manrope", "sans-serif"],
        button: ["Heebo", "Manrope", "sans-serif"],
        h2: ["Heebo", "Manrope", "sans-serif"],
      },
      fontSize: {
